...
// Ensure that the memory of RtpHeader has not released before using this object
class RtpExt {
public:
...
public:
    ...
    int parseRtpExtId(RtpPacket *rtp);
    int changeRtpExtId(RtpHeader *header);
...
private:
    OnGetRtp _cb;
    // change the rtp ext id when sending rtp
