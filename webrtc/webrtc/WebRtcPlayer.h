...
public:
    ...
    static Ptr create(const toolkit::EventPoller::Ptr &poller, const mediakit::RtspMediaSource::Ptr &src, const mediakit::MediaInfo &info);
...
private:
    WebRtcPlayer(const toolkit::EventPoller::Ptr &poller, const mediakit::RtspMediaSource::Ptr &src, const mediakit::MediaInfo &info);
