...
public:
     ...
     * @param codec 帧类型
     */
    FrameWrapper(const Buffer::Ptr &buf, uint32_t dts, uint32_t pts, size_t prefix, size_t offset, CodecId codec) : Parent(buf->data() + offset, buf->size() - offset, dts, pts, prefix){
