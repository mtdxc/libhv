...
public:
    ...
    // 获取媒体源客户端相关信息
    virtual std::shared_ptr<hv::SocketChannel> getOriginSock(MediaSource &sender) const { return nullptr; }
    ...
    */
    ...
    // 获取所在线程
    virtual hv::EventLoopPtr getOwnerPoller(MediaSource &sender) { return nullptr; }
...
public:
    ...
    std::shared_ptr<hv::SocketChannel> getOriginSock(MediaSource &sender) const override;
    ...
    hv::EventLoopPtr getOwnerPoller(MediaSource &sender) override;
...
public:
    ...
    // 获取媒体源客户端相关信息
    std::shared_ptr<hv::SocketChannel> getOriginSock() const;
    ...
    // 获取所在线程
    hv::EventLoopPtr getOwnerPoller();
...
private:
    ...
    std::weak_ptr<MediaSourceEvent> _listener;
    hv::EventLoopPtr _default_poller;
    //对象个数统计
