...
public:
    ...
    */
    ...
    // 开始发送ps-rtp
    virtual void startSendRtp(MediaSource &sender, const SendRtpArgs &args, const std::function<void(uint16_t, const SockException &)> cb) { cb(0, SockException(Err_other, "not implemented"));};
    // 停止发送ps-rtp
...
public:
    ...
    // 开始发送ps-rtp
    void startSendRtp(const MediaSourceEvent::SendRtpArgs &args, const std::function<void(uint16_t, const SockException &)> cb);
    // 停止发送ps-rtp
